        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sichtbar = table.Column<bool>(type: "bit", nullable: false),
                    Gelöscht = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Kategorien",
                columns: new[] { "ID", "Gelöscht", "Name", "Sichtbar", "Url" },
                values: new object[,]
                {
                    { 1, false, "Bücher", true, "bücher" },
                    { 2, false, "Filme", true, "filme" },
                    { 3, false, "Videospiele", true, "videospiele" }
                });
