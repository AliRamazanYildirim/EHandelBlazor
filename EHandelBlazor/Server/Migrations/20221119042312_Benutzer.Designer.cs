...
namespace EHandelBlazor.Server.Migrations
{
    ...
    [Migration("20221119042312_Benutzer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EHandelBlazor.Shared.Benutzer", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EHandelBlazor.Shared.Kategorie", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EHandelBlazor.Shared.Produkt", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EHandelBlazor.Shared.ProduktArt", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EHandelBlazor.Shared.ProduktVariante", b =>
                {
            ...
            modelBuilder.Entity("EHandelBlazor.Shared.Produkt", b =>
                {
                    b.HasOne("EHandelBlazor.Shared.Kategorie", "Kategorie")
                        .WithMany()
            ...
            modelBuilder.Entity("EHandelBlazor.Shared.ProduktVariante", b =>
                {
                    b.HasOne("EHandelBlazor.Shared.ProduktArt", "ProduktArt")
                        .WithMany()
                        .HasForeignKey("ProduktArtID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EHandelBlazor.Shared.Produkt", "Produkt")
